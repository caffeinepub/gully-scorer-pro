...
export class Backend implements backendInterface {
    ...
    async getMatchSummary(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getMatchSummary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async listMatchKeys(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMatchKeys();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveMatchSummary(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMatchSummary(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
