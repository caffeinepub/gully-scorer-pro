...
var bt = 1, yt = class {
  constructor() {
    ...
    this.create = (e) => {
      var S;
      let { message: t2, ...a } = e, u = typeof (e == null ? void 0 : e.id) == "number" || ((S = e.id) == null ? void 0 : S.length) > 0 ? e.id : bt++, f = this.toasts.find((g) => g.id === u), w = e.dismissible === void 0 ? true : e.dismissible;
    ...
    this.promise = (e, t2) => {
      ...
      let u = e instanceof Promise ? e : e(), f = a !== void 0, w, S = u.then(async (i) => {
        if (w = ["resolve", i], React$2.isValidElement(i)) f = false, this.create({ id: a, type: "default", message: i });
        else if (ie(i) && !i.ok) {
          f = false;
...
var ve = (n) => {
  ...
  let { invert: e, toast: t2, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React$2.useState(null), [lt, J] = React$2.useState(null), [W, H] = React$2.useState(false), [A, mt] = React$2.useState(false), [L, z2] = React$2.useState(false), [ct, d] = React$2.useState(false), [h, y] = React$2.useState(false), [R, j] = React$2.useState(0), [p, _] = React$2.useState(0), O = React$2.useRef(t2.duration || X || Wt), G = React$2.useRef(null), k = React$2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t2.type, V = t2.dismissible !== false, Kt = t2.className || "", Xt = t2.descriptionClassName || "", dt = React$2.useMemo(() => S.findIndex((r2) => r2.toastId === t2.id) || 0, [S, t2.id]), Jt = React$2.useMemo(() => {
    var r2;
    return (r2 = t2.closeButton) != null ? r2 : et;
  }, [t2.closeButton, et]), Tt = React$2.useMemo(() => t2.duration || X || Wt, [t2.duration, X]), gt = React$2.useRef(0), U2 = React$2.useRef(0), St = React$2.useRef(0), K = React$2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t2.invert || e, ht = N === "loading";
  ...
  }, [f, t2.id]), React$2.useLayoutEffect(() => {
    if (!W) return;
    let r2 = k.current, m = r2.style.height;
    r2.style.height = "auto";
    let c = r2.getBoundingClientRect().height;
    r2.style.height = m, _(c), f((b) => b.find((x2) => x2.toastId === t2.id) ? b.map((x2) => x2.toastId === t2.id ? { ...x2, height: c } : x2) : [{ toastId: t2.id, height: c, position: t2.position }, ...b]);
  }, [W, t2.title, t2.description, f, t2.id]);
  let $ = React$2.useCallback(() => {
    mt(true), j(U2.current), f((r2) => r2.filter((m) => m.toastId !== t2.id)), setTimeout(() => {
      T(t2);
    }, we);
  }, [t2, T, f, U2]);
  React$2.useEffect(() => {
  ...
  }, [D, u, t2, N, it, Et, $]), React$2.useEffect(() => {
    t2.delete && $();
  }, [$, t2.delete]);
  function Zt() {
    var r2, m, c;
    return P != null && P.loading ? React$2.createElement("div", { className: M(s == null ? void 0 : s.loader, (r2 = t2 == null ? void 0 : t2.classNames) == null ? void 0 : r2.loader, "sonner-loader"), "data-visible": N === "loading" }, P.loading) : rt ? React$2.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t2 == null ? void 0 : t2.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N === "loading" }, rt) : React$2.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t2 == null ? void 0 : t2.classNames) == null ? void 0 : c.loader), visible: N === "loading" });
  }
  return React$2.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N], (Pt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Pt[N]), "data-sonner-toast": "", "data-rich-colors": (Nt = t2.richColors) != null ? Nt : F, "data-styled": !(t2.jsx || t2.unstyled || a), "data-mounted": W, "data-promise": !!t2.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L, "data-dismissible": V, "data-type": N, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U2.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t2.style }, onDragEnd: () => {
    ...
    if (Math.abs(b) >= ye || I > 0.11) {
      j(U2.current), (Z = t2.onDismiss) == null || Z.call(t2, t2), J(Y === "x" ? r2 > 0 ? "right" : "left" : m > 0 ? "down" : "up"), $(), d(true), y(false);
      return;
    }
    z2(false), C(null);
  }, onPointerMove: (r2) => {
  ...
  }, className: M(s == null ? void 0 : s.closeButton, (Bt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Bt.closeButton) }, (Ct = P == null ? void 0 : P.close) != null ? Ct : Ot) : null, t2.jsx || reactExports.isValidElement(t2.title) ? t2.jsx ? t2.jsx : typeof t2.title == "function" ? t2.title() : t2.title : React$2.createElement(React$2.Fragment, null, N || t2.icon || t2.promise ? React$2.createElement("div", { "data-icon": "", className: M(s == null ? void 0 : s.icon, (kt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : kt.icon) }, t2.promise || t2.type === "loading" && !t2.icon ? t2.icon || Zt() : null, t2.type !== "loading" ? t2.icon || (P == null ? void 0 : P[N]) || jt(N) : null) : null, React$2.createElement("div", { "data-content": "", className: M(s == null ? void 0 : s.content, (It = t2 == null ? void 0 : t2.classNames) == null ? void 0 : It.content) }, React$2.createElement("div", { "data-title": "", className: M(s == null ? void 0 : s.title, (Mt = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Mt.title) }, typeof t2.title == "function" ? t2.title() : t2.title), t2.description ? React$2.createElement("div", { "data-description": "", className: M(at, Xt, s == null ? void 0 : s.description, (Ht = t2 == null ? void 0 : t2.classNames) == null ? void 0 : Ht.description) }, typeof t2.description == "function" ? t2.description() : t2.description) : null), reactExports.isValidElement(t2.cancel) ? t2.cancel : t2.cancel && tt(t2.cancel) ? React$2.createElement("button", { "data-button": true, "data-cancel": true, style: t2.cancelButtonStyle || ft, onClick: (r2) => {
    var m, c;
    tt(t2.cancel) && V && ((c = (m = t2.cancel).onClick) == null || c.call(m, r2), $());
  }, className: M(s == null ? void 0 : s.cancelButton, (At = t2 == null ? void 0 : t2.classNames) == null ? void 0 : At.cancelButton) }, t2.cancel.label) : null, reactExports.isValidElement(t2.action) ? t2.action : t2.action && tt(t2.action) ? React$2.createElement("button", { "data-button": true, "data-action": true, style: t2.actionButtonStyle || l, onClick: (r2) => {
    var m, c;
    tt(t2.action) && ((c = (m = t2.action).onClick) == null || c.call(m, r2), !r2.defaultPrevented && $());
...
function Te(n, e) {
  ...
  return [n, e].forEach((a, u) => {
    ...
    typeof a == "number" || typeof a == "string" ? g(a) : typeof a == "object" ? ["top", "right", "bottom", "left"].forEach((i) => {
      a[i] === void 0 ? t2[`${w}-${i}`] = S : t2[`${w}-${i}`] = typeof a[i] == "number" ? `${a[i]}px` : a[i];
    }) : g(S);
  }), t2;
}
var $e = reactExports.forwardRef(function(e, t2) {
  let { invert: a, position: u = "bottom-right", hotkey: f = ["altKey", "KeyT"], expand: w, closeButton: S, className: g, offset: i, mobileOffset: D, theme: T = "light", richColors: F, duration: et, style: ut, visibleToasts: ft = pe, toastOptions: l, dir: ot = _t(), gap: at = be, loadingIcon: X, icons: st, containerAriaLabel: pt = "Notifications", pauseWhenPageIsHidden: rt } = e, [B, s] = React$2.useState([]), P = React$2.useMemo(() => Array.from(new Set([u].concat(B.filter((d) => d.position).map((d) => d.position)))), [B, u]), [nt, it] = React$2.useState([]), [Y, C] = React$2.useState(false), [lt, J] = React$2.useState(false), [W, H] = React$2.useState(T !== "system" ? T : typeof window != "undefined" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), A = React$2.useRef(null), mt = f.join("+").replace(/Key/g, "").replace(/Digit/g, ""), L = React$2.useRef(null), z2 = React$2.useRef(false), ct = React$2.useCallback((d) => {
    s((h) => {
      var y;
      return (y = h.find((R) => R.id === d.id)) != null && y.delete || v.dismiss(d.id), h.filter(({ id: R }) => R !== d.id);
    });
  }, []);
  return React$2.useEffect(() => v.subscribe((d) => {
    if (d.dismiss) {
  ...
  }, [A.current]), React$2.createElement("section", { ref: t2, "aria-label": `${pt} ${mt}`, tabIndex: -1, "aria-live": "polite", "aria-relevant": "additions text", "aria-atomic": "false", suppressHydrationWarning: true }, P.map((d, h) => {
    var j;
    let [y, R] = d.split("-");
    return B.length ? React$2.createElement("ol", { key: d, dir: ot === "auto" ? _t() : ot, tabIndex: -1, ref: A, className: g, "data-sonner-toaster": true, "data-theme": W, "data-y-position": y, "data-lifted": Y && B.length > 1 && !w, "data-x-position": R, style: { "--front-toast-height": `${((j = nt[0]) == null ? void 0 : j.height) || 0}px`, "--width": `${he}px`, "--gap": `${at}px`, ...ut, ...Te(i, D) }, onBlur: (p) => {
...
function recalculateMatch(history, settings, inningsSide = 1) {
  ...
  const batMap = /* @__PURE__ */ new Map();
  const bowlMap = /* @__PURE__ */ new Map();
  const getBatter = (i) => {
    if (!batMap.has(i))
      batMap.set(i, {
        index: i,
...
function t(lang, key) {
  var _a2;
  return ((_a2 = translations[lang]) == null ? void 0 : _a2[key]) ?? translations.en[key] ?? key;
}
function uid() {
  return `${Date.now()}-${Math.random().toString(36).slice(2, 7)}`;
}
function checkInningsEnd(calc, settings) {
  ...
  const maxWickets = settings.lastManStands ? settings.playersPerSide - 1 : settings.playersPerSide - 1;
  if (calc.wickets >= maxWickets) return "allout";
  return null;
}
function InningsBreak({ state, onStartInnings2 }) {
  const lang = state.language;
  const target = (state.team1FinalRuns ?? 0) + 1;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-6 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: "🏏" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-black mb-2", children: t(lang, "innings2") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-6 w-full max-w-sm mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground text-sm mb-1", children: [
        state.settings.team1Name,
        " scored"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-5xl font-black text-primary", children: [
        state.team1FinalRuns,
        "/",
        state.team1FinalWickets
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground text-sm", children: [
        state.team1FinalOvers,
        " overs"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 bg-accent/20 rounded-xl border border-accent", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-accent font-black text-xl", children: [
          t(lang, "target"),
          ": ",
          target
        ] }),
...
function ShareModal({ state, onClose }) {
  ...
  const calc2 = state.innings === 2 ? recalculateMatch(state.matchHistory, state.settings, 2) : null;
  ...
  if (calc2) {
    ...
    } else if (calc2.wickets >= state.settings.playersPerSide - 1 || calc2.completedOvers * 6 + calc2.currentBall >= state.settings.maxOvers * 6) {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-yellow-400 font-black text-xl tracking-wide", children: "GULLY SCORER PRO" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white font-bold text-base mt-1", children: [
                  state.settings.team1Name,
                  " vs ",
                  state.settings.team2Name
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] rounded-xl p-4 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-yellow-400 text-xs font-bold uppercase mb-1", children: [
                  "1st Innings — ",
                  state.settings.team1Name
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white font-black text-4xl", children: [
                  calc1.totalRuns,
                  "/",
                  calc1.wickets
                ] }),
              ...
              calc2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] rounded-xl p-4 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-yellow-400 text-xs font-bold uppercase mb-1", children: [
                  "2nd Innings — ",
                  state.settings.team2Name
                ] }),
              ...
              resultText && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-400 rounded-xl p-3 mb-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-black font-black text-lg", children: resultText }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                topBatter && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] rounded-lg p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-yellow-400 text-xs font-bold", children: t(lang, "topBatter") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-sm mt-1", children: topBatter.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-gray-300 text-xs", children: [
                    topBatter.runs,
                    " (",
                    topBatter.balls,
                    "b)"
                ...
                topBowler && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#111] rounded-lg p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-yellow-400 text-xs font-bold", children: t(lang, "topBowler") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-sm mt-1", children: topBowler.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-gray-300 text-xs", children: [
                    topBowler.wickets,
                    "w / ",
                    topBowler.overs,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-3 text-gray-600 text-xs", children: "gullyscorerpro.app" })
            ]
          }
        ),
...
function ResultScreen({ state, onNewMatch }) {
  const lang = state.language;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary text-primary-foreground text-center py-6 px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-2", children: "🏆" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-black", children: winnerTeam || "Match Tied" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold opacity-90", children: resultText })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border p-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold mb-1", children: state.settings.team1Name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl font-black", children: [
          calc1.totalRuns,
          "/",
          calc1.wickets
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border p-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold mb-1", children: state.settings.team2Name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl font-black", children: [
          calc2.totalRuns,
          "/",
          calc2.wickets
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "bat1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full grid grid-cols-4 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "bat1", className: "text-xs", children: [
          state.settings.team1Name,
          " Bat"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "bowl1", className: "text-xs", children: "Bowl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "bat2", className: "text-xs", children: [
          state.settings.team2Name,
          " Bat"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "bowl2", className: "text-xs", children: "Bowl" })
      ] }),
      [1, 2].map((inn) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React$2.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: `bat${inn}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-5 gap-1 px-3 py-2 bg-muted text-xs font-bold text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-2", children: t(lang, "batter") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t(lang, "r") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t(lang, "b") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t(lang, "sr") })
          ] }),
          (inn === 1 ? calc1 : calc2).batterStats.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "grid grid-cols-5 gap-1 px-3 py-2 border-t border-border text-sm",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "col-span-2 font-medium truncate", children: [
                  b.name,
                  b.isOut && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive text-xs ml-1", children: "out" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right font-bold", children: b.runs }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right text-muted-foreground", children: b.balls }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right text-muted-foreground", children: b.strikeRate })
              ]
            },
            b.index
          )),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-t border-border text-sm text-muted-foreground", children: [
            "Extras: ",
            (inn === 1 ? calc1 : calc2).extras.total,
            " (W:",
            " ",
            (inn === 1 ? calc1 : calc2).extras.wides,
            ", NB:",
            " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: `bowl${inn}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-5 gap-1 px-3 py-2 bg-muted text-xs font-bold text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-2", children: t(lang, "bowl") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t(lang, "o") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t(lang, "w") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: t(lang, "eco") })
          ] }),
          (inn === 1 ? calc1 : calc2).bowlerStats.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "grid grid-cols-5 gap-1 px-3 py-2 border-t border-border text-sm",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-2 font-medium truncate", children: b.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-right", children: [
                  b.overs,
                  ".",
                  b.balls % 6
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right font-bold text-destructive", children: b.wickets }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right text-muted-foreground", children: b.economy })
              ]
            },
            b.index
          ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-0 left-0 right-0 p-4 bg-background border-t border-border flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          size: "lg",
    ...
    showShare && /* @__PURE__ */ jsxRuntimeExports.jsx(ShareModal, { state, onClose: () => setShowShare(false) })
  ] });
}
...
function Timeline({ history, onBallClick, inningsSide }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        last10.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs px-2", children: "No balls yet — start scoring!" }),
        last10.map((ball, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function CorrectionModal({
  ...
  const [edited, setEdited] = reactExports.useState({ ...ball });
  const setRuns = (r2) => setEdited((b) => ({ ...b, runs: r2, isWicket: false }));
  const setWicket = () => setEdited((b) => ({ ...b, runs: 0, isWicket: true, extraType: "none" }));
  const setExtra = (type) => setEdited((b) => ({ ...b, extraType: type, isWicket: false }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl w-full max-w-sm p-5 fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-black mb-1", children: t(lang, "correction") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wide text-muted-foreground mb-2", children: "Runs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-6 gap-2 mb-3", children: runBtns.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: `h-12 rounded-lg font-black text-lg border-2 transition-all ${edited.runs === r2 && !edited.isWicket ? "bg-primary text-primary-foreground border-primary" : "bg-muted border-border"}`,
            onClick: () => setRuns(r2),
            children: r2
          },
          r2
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            className: `w-full h-12 rounded-lg font-black text-lg border-2 mb-3 transition-all ${edited.isWicket ? "bg-destructive text-destructive-foreground border-destructive" : "bg-muted border-border"}`,
            onClick: setWicket,
            children: "OUT / W"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wide text-muted-foreground mb-2", children: "Extra Type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2 mb-5", children: ["none", "wide", "noball", "dead"].map(
          (et) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              className: `h-10 rounded-lg font-bold text-sm border-2 transition-all ${edited.extraType === et ? "bg-accent text-accent-foreground border-accent" : "bg-muted border-border"}`,
              onClick: () => setExtra(et),
              children: et === "none" ? "None" : et === "wide" ? "Wide" : et === "noball" ? "NB" : "Dead"
            },
            et
          )
        ) }),
...
function RulesModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-t-2xl w-full max-w-lg p-5 pb-8 fade-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-black", children: [
            "⚡ ",
            t(lang, "rules")
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-black", children: t(lang, "wallRuns") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-70", children: "Ball hits the wall = +1 run" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🏠" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-black", children: t(lang, "neighborsHouse") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-70", children: "Ball goes next door = OUT!" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🚫" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-black", children: t(lang, "deadBall") }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs opacity-70", children: "Ball doesn't count — re-bowl" })
                ] })
              ]
            }
          )
...
function SettingsModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-t-2xl w-full max-w-lg p-5 pb-8 fade-up max-h-[85vh] overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-black", children: [
            "⚙️ ",
            t(lang, "settings")
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", onClick: onClose, children: "✕" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: t(lang, "maxOvers") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: t(lang, "playersPerSide") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: t(lang, "wideRuns") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: t(lang, "noballRuns") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 rounded-lg bg-muted", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
                checked: s.lastManStands,
                onCheckedChange: (v2) => set("lastManStands", v2)
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-sm", children: t(lang, "lastManStands") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Last batter can continue alone" })
            ] })
          ] })
        ] }),
...
function WicketModal({ state, onSelect }) {
  const lang = state.language;
  ...
  const onField = /* @__PURE__ */ new Set([state.currentBatterIndex, state.nonStrikerIndex]);
  const available = Array.from(
    { length: state.settings.playersPerSide },
    (_, i) => i
  ).filter((i) => !outIndices.has(i) && !onField.has(i));
  const isLastMan = calc.wickets >= state.settings.playersPerSide - 2 && state.settings.lastManStands;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "fixed inset-0 bg-black/80 z-50 flex items-end justify-center",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-t-2xl w-full max-w-lg p-5 pb-8 fade-up", children: [
        ...
        isLastMan && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent/20 border border-accent rounded-lg p-3 mb-4 text-sm font-bold", children: [
          "⚡ ",
          t(lang, "lastManStands"),
          " — Last batter can continue alone!"
        ] }),
        calc.wickets >= state.settings.playersPerSide - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-3", children: "💀" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-xl", children: "All Out!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mt-4 w-full", onClick: () => onSelect(-1), children: "End Innings" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-64 overflow-y-auto", children: available.map((playerIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🏏" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: state.settings.players[playerIdx] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-muted-foreground text-sm", children: [
                "#",
                playerIdx + 1
              ] })
            ]
...
function ScoringScreen({ state, onChange }) {
  const lang = state.language;
  const [activeModal, setActiveModal] = reactExports.useState(null);
  const [correctionBall, setCorrectionBall] = reactExports.useState(null);
  const [showBowlerSelect, setShowBowlerSelect] = reactExports.useState(false);
  const pendingStateRef = reactExports.useRef(null);
  const calc = recalculateMatch(
    state.matchHistory,
    state.settings,
    state.innings
  );
  const inningsLabel = state.innings === 1 ? `${state.settings.team1Name} Batting` : `${state.settings.team2Name} Batting`;
  const addBall = reactExports.useCallback(
    (partial) => {
      ...
      if (ball.isWicket) {
        vibrate("wicket");
        const newCalc2 = recalculateMatch(
          newHistory,
          state.settings,
          state.innings
        );
        const target22 = state.innings === 2 && state.team1FinalRuns !== void 0 ? state.team1FinalRuns + 1 : null;
        if (target22 !== null && newCalc2.totalRuns >= target22) {
          onChange({ ...newState, phase: "result" });
          return;
        }
        const end2 = checkInningsEnd(newCalc2, state.settings);
        if (end2) {
          if (state.innings === 1) {
            newState = {
              ...newState,
              phase: "innings_break",
              team1FinalRuns: newCalc2.totalRuns,
              team1FinalWickets: newCalc2.wickets,
              team1FinalOvers: newCalc2.oversStr
            };
          } else {
      ...
      const target2 = state.innings === 2 && state.team1FinalRuns !== void 0 ? state.team1FinalRuns + 1 : null;
      ...
      if (newCalc.currentBall === 0 && newCalc.completedOvers > calc.completedOvers) {
        newState = {
          ...newState,
  ...
  const handleUndo = () => {
    ...
    let newState = { ...state, matchHistory: newHistory };
    if (lastBall == null ? void 0 : lastBall.isWicket) {
      newState = {
        ...newState,
  ...
  const editBatterName = (index2) => {
    const current = state.settings.players[index2];
    const newName = window.prompt(t(lang, "editName"), current);
    if (!newName || newName === current) return;
    const players = [...state.settings.players];
    players[index2] = newName;
    onChange({ ...state, settings: { ...state.settings, players } });
  };
  const editBowlerName = (index2) => {
    const current = state.settings.bowlers[index2];
    const newName = window.prompt(t(lang, "editName"), current);
    if (!newName || newName === current) return;
    const bowlers = [...state.settings.bowlers];
    bowlers[index2] = newName;
    onChange({ ...state, settings: { ...state.settings, bowlers } });
  };
  const editBowler = () => {
    const list = state.settings.bowlers.map((n, i2) => `${i2 + 1}. ${n}`).join("\n");
...
${list}`
  ...
  const handleWicketSelect = (nextIndex) => {
    setActiveModal(null);
    if (nextIndex === -1) {
      const newCalc = recalculateMatch(
        state.matchHistory,
  ...
  const target = state.innings === 2 && state.team1FinalRuns !== void 0 ? state.team1FinalRuns + 1 : null;
  const runsNeeded = target ? target - calc.totalRuns : null;
  const bowlerListItems = state.settings.bowlers.slice(0, state.settings.playersPerSide).map((name, i) => ({ name, i, key: `bowler-slot-${i}` }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 pt-3 pb-2 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-black text-xs text-muted-foreground uppercase tracking-wide", children: [
          state.innings === 1 ? t(lang, "innings1") : t(lang, "innings2"),
          " —",
          " ",
          inningsLabel
        ] }),
        target && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-accent font-bold", children: [
          t(lang, "target"),
          ": ",
          target,
          " (",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            onClick: () => onChange({ ...state, language: lang === "en" ? "hi" : "en" }),
            "data-ocid": "scoring.language_toggle",
            children: lang === "en" ? "हि" : "EN"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-3 px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "score-display text-7xl text-foreground", children: [
        calc.totalRuns,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-4xl", children: [
          "/",
          calc.wickets
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-muted-foreground text-sm font-bold mt-1", children: [
        calc.oversStr,
        " / ",
        state.settings.maxOvers,
        " ",
        t(lang, "overs"),
        calc.extras.total > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-accent", children: [
          "• Extras: ",
          calc.extras.total
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 grid grid-cols-2 gap-2 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary font-bold uppercase mb-1", children: t(lang, "striker") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: state.settings.players[state.currentBatterIndex]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xl font-black mt-1", children: [
              (strikerStats == null ? void 0 : strikerStats.runs) ?? 0,
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground ml-1", children: [
                "(",
                (strikerStats == null ? void 0 : strikerStats.balls) ?? 0,
                "b)"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
              "4s: ",
              (strikerStats == null ? void 0 : strikerStats.fours) ?? 0,
              " | 6s: ",
              (strikerStats == null ? void 0 : strikerStats.sixes) ?? 0
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase mb-1", children: t(lang, "nonStriker") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: state.settings.players[state.nonStrikerIndex]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xl font-black mt-1", children: [
              (nonStrikerStats == null ? void 0 : nonStrikerStats.runs) ?? 0,
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground ml-1", children: [
                "(",
                (nonStrikerStats == null ? void 0 : nonStrikerStats.balls) ?? 0,
                "b)"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
              "4s: ",
              (nonStrikerStats == null ? void 0 : nonStrikerStats.fours) ?? 0,
              " | 6s:",
              " ",
              (nonStrikerStats == null ? void 0 : nonStrikerStats.sixes) ?? 0
            ] })
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold uppercase", children: t(lang, "bowler") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: state.settings.bowlers[state.currentBowlerIndex]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-black", children: [
              Math.floor(((bowlerStats == null ? void 0 : bowlerStats.balls) ?? 0) / 6),
              ".",
              ((bowlerStats == null ? void 0 : bowlerStats.balls) ?? 0) % 6,
              " ov"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground", children: [
              (bowlerStats == null ? void 0 : bowlerStats.runs) ?? 0,
              "r | ",
              (bowlerStats == null ? void 0 : bowlerStats.wickets) ?? 0,
              "w"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-bold px-3 pt-2", children: "Last 10 Balls" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Timeline,
        {
          history: state.matchHistory,
          inningsSide: state.innings,
          onBallClick: (ball, index2) => {
            setCorrectionBall({ ball, index: index2 });
            setActiveModal("correction");
          }
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-36" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "thumb-zone", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-7 gap-1.5 mb-1.5", children: [
        [0, 1, 2, 3].map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: "score-btn bg-secondary rounded-xl border border-border",
            onClick: () => addBall({ runs: r2 }),
            "data-ocid": `scoring.btn_${r2}`,
            children: r2
          },
          r2
        )),
    ...
    activeModal === "rules" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      RulesModal,
      {
        lang,
        onWallRun: () => {
    ...
    activeModal === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      SettingsModal,
      {
        lang,
    ...
    activeModal === "correction" && correctionBall && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CorrectionModal,
      {
    ...
    activeModal === "wicket" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      WicketModal,
      {
        state,
    ...
    activeModal === "share" && /* @__PURE__ */ jsxRuntimeExports.jsx(ShareModal, { state, onClose: () => setActiveModal(null) }),
    showBowlerSelect && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "fixed inset-0 bg-black/80 z-50 flex flex-col justify-end",
        "data-ocid": "bowler_select.modal",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-t-2xl p-4 pb-8 max-h-[70vh] overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-1", children: "🎳" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-black text-lg", children: "End of Over" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: t(lang, "selectBowler") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: bowlerListItems.map(({ name, i, key }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                ...
                i === state.currentBowlerIndex && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "(current)" })
              ]
            },
            key
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "Skip (Keep Current Bowler)"
            }
          )
        ] })
      }
...
function SetupScreen({ state, onStart }) {
  const lang = state.language;
  const [s, setS] = reactExports.useState(state.settings);
  const set = (key, val) => setS((prev) => ({ ...prev, [key]: val }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground px-4 py-6 pb-24 overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-2", children: "🏏" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-black text-primary", children: t(lang, "appName") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Setup your match" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 justify-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          size: "sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          onClick: () => onStart({ ...state, settings: s, solarMode: !state.solarMode }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-lg mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1", children: t(lang, "team1") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: s.team1Name,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1", children: t(lang, "team2") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: s.team2Name,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1", children: t(lang, "maxOvers") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1", children: t(lang, "playersPerSide") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1", children: t(lang, "wideRuns") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1", children: t(lang, "noballRuns") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: playerSlots.map(({ slot, name }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: name,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: bowlerSlots.map(({ slot, name }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 p-4 bg-background border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        size: "lg",
...
function App() {
  ...
  const setState = reactExports.useCallback((newState) => {
  ...
  reactExports.useEffect(() => {
    ...
    if (state.solarMode) {
      root2.classList.add("solar-mode");
    } else {
      root2.classList.remove("solar-mode");
    }
  }, [state.solarMode]);
  const startInnings2 = () => {
    setState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: state.solarMode ? "solar-mode" : "", children: [
    state.phase === "setup" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      SetupScreen,
      {
        state,
        onStart: (newState) => setState({
          ...newState,
          phase: newState.phase === "setup" ? "setup" : "batting"
        })
      }
    ),
    state.phase === "batting" && /* @__PURE__ */ jsxRuntimeExports.jsx(ScoringScreen, { state, onChange: setState }),
    state.phase === "innings_break" && /* @__PURE__ */ jsxRuntimeExports.jsx(InningsBreak, { state, onStartInnings2: startInnings2 }),
    state.phase === "result" && /* @__PURE__ */ jsxRuntimeExports.jsx(ResultScreen, { state, onNewMatch: newMatch }),
...
-> ${e.message}`);
  ...
  decodeValue(b, t2) {
    ...
    if (wireType instanceof OptClass) {
      ...
      const checkpoint = b.save();
      try {
        const v2 = this._type.decodeValue(b, t2);
        return [v2];
      } catch (e) {
        b.restore(checkpoint);
        wireType.decodeValue(b, t2);
        return [];
      }
    }
  }
...
class RecordClass extends ConstructType {
  ...
  covariant(x2) {
    if (typeof x2 === "object" && this._fields.every(([k, t2]) => {
      if (!x2.hasOwnProperty(k)) {
        throw new Error(`Record is missing key "${k}".`);
      }
      try {
        return t2.covariant(x2[k]);
      } catch (e) {
        throw new Error(`Invalid ${this.display()} argument: 
...
Service({
  "getMatchSummary": Func([Text], [Text], ["query"]),
  "listMatchKeys": Func([], [Vec(Text)], ["query"]),
  "saveMatchSummary": Func([Text, Text], [], [])
});
